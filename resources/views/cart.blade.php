                                    ...
                                    @foreach ($cart->items as $item)
                                        <tr>
                                            <td class="cart-product-remove">
                                                <a href="/deleteProductFromCart/{{$item['data']['id']}}"><i class="fa fa-times"></i></a>
                                            </td>
                                            <td class="cart-product-thumbnail">
                                                <a href="#">
                                                    <img src="{{ asset('product_images/'.$item['data']['image']) }}" alt="Bolt Sweatshirt">
                                                </a>
                                            <div class="cart-product-thumbnail-name">{{$item['data']['name']}}</div>
                                            </td>
                                            {{-- <td class="cart-product-description"> --}}
                                                {{-- <p><span>{{$item['data']['name']}}</span> --}}
                                                    {{-- <span>Size: M</span> --}}
                                            ...
                                            <td class="cart-product-price">
                                                <span class="amount">{{$item['data']['price']}}</span>
                                            </td>
                                            <td class="cart-product-quantity">
                                                <div class="quantity">
                                                    <input type="button" class="minus" value="-" onClick="decrement_quantity({{$item['data']['id']}})">
                                                <input type="text" readonly class="qty" id="input-quantity-{{$item['data']['id']}}" value="{{$item['quantity']}}" name="quantity">
                                                    <input type="button" class="plus" value="+"  onClick="increment_quantity({{$item['data']['id']}})">
                                                </div>
                                            </td>
                                            <td class="cart-product-subtotal">
                                            <span class="amount totalPriceField1-{{$item['data']['id']}}">₹{{$item['price']*$item['quantity']}}</span>
                                            </td>
                                        </tr>          
                                    @endforeach
                                    ...
                                    <table class="table">
                                        <tbody>
                                            <tr>
                                                ...
                                                <span class="amount totalPriceField2">₹{{$cart->totalPrice}}</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="cart-product-name">
                                            ...
                                            <tr>
                                                ...
                                                <td class="cart-product-name text-right">
                                                    <span class="amount color lead totalPriceField3" ><strong>₹{{$cart->totalPrice}}</strong></span>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                                <a href="/checkout" class="btn icon-left float-right"><span>Proceed to Checkout</span></a>
                            </div>
                        </div>
                    </div>
                </div>
